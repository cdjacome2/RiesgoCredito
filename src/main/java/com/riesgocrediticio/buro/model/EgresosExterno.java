...
@Entity
@Table(name = "egresos", schema = "buro_externo")
public class EgresosExterno {
    ...
    // Constructores
    public EgresosExterno() {
    }

    public EgresosExterno(Long id) {
        this.id = id;
    }
    ...
    public ProductoExternoEnum getProducto() {
        return producto;
    }

    public void setProducto(ProductoExternoEnum producto) {
    ...
    public boolean equals(Object o) {
        ...
        EgresosExterno that = (EgresosExterno) o;
