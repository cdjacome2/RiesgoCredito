...
@Entity
@Table(name = "ingresos", schema = "buro_interno")
public class IngresosInterno {
    ...
    // Constructores
    public IngresosInterno() {
    }

    public IngresosInterno(Long id) {
        this.id = id;
    }
    ...
    public boolean equals(Object o) {
        ...
        IngresosInterno that = (IngresosInterno) o;
